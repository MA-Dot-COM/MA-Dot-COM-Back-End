...
/**
 * <pre>
 * Class : S3 FurnitureImageFile
 * Comment: S3 가구 이미지 파일 저장
 * History
 * ================================================================
 * DATE             AUTHOR           NOTE
 * ----------------------------------------------------------------
...
public class S3FurnitureImageFile {
    private static final Logger log = LoggerFactory.getLogger(S3FurnitureImageFile.class);
    private final AmazonS3Client amazonS3Client;

    @Value("${cloud.aws.s3.bucket}")
    private String bucket;

    public String upload(byte[] furnitureImage, String changeName, String dirName) throws IOException {

        ByteArrayInputStream input_stream= new ByteArrayInputStream(furnitureImage);
