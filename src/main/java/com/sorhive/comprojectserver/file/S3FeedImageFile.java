...
public class S3FeedImageFile {
    ...
    public String upload(byte[] feedImage, String changeName, String dirName) throws IOException {

        ByteArrayInputStream input_stream= new ByteArrayInputStream(feedImage);
