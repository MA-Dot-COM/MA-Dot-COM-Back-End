...
public class ChattingWriter {
    ...
    @Column(name = "chatting_writer_name")
    private String name;

    protected ChattingWriter() {}

    public ChattingWriter(MemberCode memberCode, String name) {
    ...
    public boolean equals(Object o) {
        ...
        ChattingWriter writer = (ChattingWriter) o;
        return Objects.equals(memberCode, writer.memberCode) && Objects.equals(name, writer.name);
    }
