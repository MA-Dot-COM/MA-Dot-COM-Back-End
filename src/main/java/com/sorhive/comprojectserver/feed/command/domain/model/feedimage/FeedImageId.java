...
public class FeedImageId implements Serializable {
    ...
    protected FeedImageId () {
    }

    public FeedImageId(Long value) { this.value = value; }
    ...
    public boolean equals(Object o) {
        ...
        FeedImageId that = (FeedImageId) o;
    ...
    public static FeedImageId of(Long value) { return  new FeedImageId(value); }
}
